...
system('cls');
system('title Admin Control Panel Finder Coded by Codot_id from www.cyruscyberid.tk');
...
print "                        Coded By Codot_id  \n" ;
print "                     website:www.cyruscyberid.tk \n\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";

print " MASUKAN WEBSITE YANG MAO LU SCAN ADMIN PANELNYA \n";
print"  Contoh : www.Nekopoi.Croot atau www.Nekopoi.Croot/path\n";
print" --> ";
$site=<STDIN>;
chomp $site;

print "\n\n";
print " Masukan Type Websitenya  \n";
print" Contoh: asp, php, cfm, gaktau\n";
print" Kalo lu gak tau Type Webnya Pilih Ajah gaktau Kampreet -_- \n";
print"--> ";
$code=<STDIN>;
chomp($code);
...
print "->Web Target Loe : $site\n";
print "->Source website : $code\n";
print "->TUNGGUIN LAGI LOADING SCANNING !!!...\n\n\n";
...
print " \n [+] Found -> $final\n\n";
print " \n CIEEE KETEMUU Adminnya ^_^. \n\n Good luck from All Member CYRUS_CYBER  \n\n";
}else{
